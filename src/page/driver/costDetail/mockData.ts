...
export const mockData: UserData = {
  users: [
    ...
    },
    {
      ...
      price: 5200000,
      movingRequest: '대형 가구 있어 특별 주의 필요, 주말 오전 이동 희망',
    },
    {
      estimateId: 3,
      movingType: 'OFFICE',
      ...
      price: 8500000,
      movingRequest: '사무용 고가 장비 운송, 전문 포장 필요',
    },
    {
      estimateId: 4,
      movingType: 'SMALL',
      ...
      price: 180000,
      movingRequest: '반려견 동반, 애완용품 특별 취급 요망',
    },
    {
      estimateId: 5,
      movingType: 'HOUSE',
      ...
      price: 4700000,
      movingRequest: '3층 주택, 좁은 계단 있음. 가구 분해 후 운송 필요',
    },
    {
      estimateId: 6,
      movingType: 'OFFICE',
      ...
      price: 6300000,
      movingRequest: '중요 서류 및 컴퓨터 장비 운송, 최대한 주의 요망',
    },
    {
      estimateId: 7,
      movingType: 'SMALL',
      ...
      price: 150000,
      movingRequest: '오후 이동 선호, 짐 적은 편임',
    },
    {
      estimateId: 8,
      movingType: 'HOUSE',
      ...
      price: 3900000,
      movingRequest: '피아노 운송 필요, 전문 취급 요청',
    },
    {
      estimateId: 9,
      movingType: 'OFFICE',
    ...
    },
    {
      ...
      price: 120000,
      movingRequest: '1인 가구, 짐 적고 간단한 이동',
    },
  ],
};
